 ...
 */
  ...
  private:
   void HorizontalWall(int width, int height, int randNum, int count); // count is not needed anymore
   void VerticalWall(int width, int height, int randNum, int count); // count is not needed anymore
   //cs225::PNG* png_;
   DisjointSets connected_;
